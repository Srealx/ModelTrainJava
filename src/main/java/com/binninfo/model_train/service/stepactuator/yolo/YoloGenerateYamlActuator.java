 ...
 */
@Slf4j
@ModelTaskStep(model = ModelEnum.YOLO,taskTypeCode= TaskTypeConstant.ARBITRARY, stepNumber = YoloModelTaskStepConstant.GENERATE_YAML_CODE)
public class YoloGenerateYamlActuator extends YoloModelTaskStepStepActuator {
    @Override
    ...
    public YoloModelTaskStepEnum getStep() {
        return YoloModelTaskStepEnum.GENERATE_YAML;
    }
}
